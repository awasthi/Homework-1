...
way in whic hthe interior of \(A\) is related to open subsets of \(X\)
...
\begin{theorem}
  Let \(A\) be a subset of a metric space \(X\). Then \(X\setminus\bar
  A=(X\setminus A)^\circ\) and \(X\setminus A^\circ=\overline{X\setminus
    A}\).
\end{theorem}
