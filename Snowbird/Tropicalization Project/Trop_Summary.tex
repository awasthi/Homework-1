...
\documentclass[11pt,showtrims]{article}
...
$\Newt(f)$. The Figure \cite{fig:f3-sl2c} is a picture made we made using
the Ti\textit{k}Z language to draw the edge graph of $\Newt(f)$
