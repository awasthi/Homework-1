...
\def\documenttitle{Snowbird Workshop -- Character Varieties}
\def\shorttitle{Snowbird\_CharVar}
\def\coursename{character varieties}
\def\documentsubject{character varieties, representation theory, etc}
...
%% Notes
\mainmatter
% \include{workshop/day-0}
% \include{workshop/day-0-alggeom}

\include{workshop/lawton-1}
% \include{workshop/lawton-2}

\include{workshop/manon-1}
% \include{workshop/manon-2}

%% References
% \backmatter
% \bibliographystyle{plain}
% \bibliography{snowbird-refs}
% \printindex
\end{document}
