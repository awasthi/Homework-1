...
\begin{problem}
  ...
  \[
    a(x,y)+b(x,y)y>0
  \]
  for any \(x,y\in\bfR^n\setminus\{(0,0)\}\).
...
\begin{problem}
  Let \(u\in C^2\bigl(\bfR\times[0,\infty)\bigr)\) be a solution of the
  initial value problem for the one-dimensional wave equation
  \[
    \left\{
      \begin{aligned}
        u_{tt}-u_{xx}&=0&&&&\text{on \(\bfR\times(0,\infty)\),}\\
        u&=f,&u_t&=g&&\text{in \(\bfR\times 0\),}
      \end{aligned}
    \right.
  \]
...
\begin{problem}
  ...
  \[
    \left\{
      \begin{aligned}
        u_{tt}-\Delta u&=\rme^{-t} g(x)&&\text{for \(x\in\bfR^3\), \(t>0\),}\\
        u(x,0)&=u_t(x,0)=0&&\text{for \(x\in\bfR^3\).}
      \end{aligned}
    \right.
  \]
...
\begin{problem}
  Let \(\Omega\) be a bounded open set in \(\bfR^n\) and \(g\in
  ...
  \[
    \left\{
      \begin{aligned}
        \Delta v-v_t&=0&&\text{for \(x\in\bfR^n\), \(t>0\),}\\
        v(x,0)&=|g(x)|&&\text{for \(x\in\bfR^n\),}
      \end{aligned}
    \right.
  \]
...
\begin{problem}
  ...
  \(\bfR^n\) of degrees \(k\) and \(m\) respectively; i.e.,
  \[
    P_k(\lambda x)=\lambda^kP_k(x),\qquad P_m(\lambda x)=\lambda^mP_m(x),
  \]
  for any \(x\in\bfR^n\), \(\lambda>0\),
  \[
