...
\begin{problem}
  ...
  \[
    \left\{
      \begin{aligned}
        u_t-\Lap u&=0&&\text{for \(x\in\bbR^n\), \(t>0\),}\\
...
\begin{problem}
  ...
  \[
    \left\{
      \begin{aligned}
        u_{tt}-\Lap u=0&&&\text{in \(\bbR^n\times(0,\infty),\)}\\
...
\begin{problem}
  ...
  \[
    \left\{
      \begin{aligned}
        u_{tt}-\Lap u=0&&&\text{for \(x\in\bbR^3\), \(t>0\),}\\
...
\begin{problem}
  ...
  \[
    \left\{
      \begin{aligned}
        u_{tt}-\Lap u=\rme^{-t}f(x)&&\text{\(x\in\bbR^3\), \(t>0\),}\\
...
\begin{problem}
  ...
  \[
    \left\{
      \begin{aligned}
        u_t-\Lap u=0&&\text{in \(\bbR^n\times(0,\infty)\),}\\
