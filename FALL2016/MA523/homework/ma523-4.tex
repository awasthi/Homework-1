...
%       \right]\\
%       &=x^1_{p_2}(p)+x^1_{p_1p_2}(p)p^1+x^2_{p_1}(p)+x^2_{p_1p_2}(p)p^2\\
...
%       &=x^1_{p_2}+x^1_{p_1p_2}p^1+x^2_{p_1}+x^2_{p_1p_2}p^2\\
%       &\phantom{{}={}}-u_{x_1}x^1_{p_1p_2}-\bigl[u_{x_1x_1}x^1_{p_2}
%       +u_{x_1x_2}x^2_{p_2}\bigr]x^1_{p_1}\\
%       &\phantom{{}={}}-u_{x_2}x^2_{p_1p_2}-
%       \bigl[
%       u_{x_1x_2}x^1_{p_2}+u_{x_2x_2}x^2_{p_2}
%       \bigr]x^2_{p_1}\\
%       &=
%     \end{aligned}
%   \end{equation}
