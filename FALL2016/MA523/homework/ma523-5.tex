...
\begin{solution}
  ...
  \begin{align*}
    ...
    &=%
      \begin{bmatrix}
        a_{11}^2+\dotsb+a_{1n}^2&a_{11}a_{12}+\dotsb+a_{n1}a_{n2}
  ...
  \begin{equation}
    ...
    \begin{cases}
    \text{(a) }\sum_{j=1}^na_{jk}a_{j\ell}=\sum_{j=1}^na_{jk}^2=1&\text{if \(k=\ell\),}\\
    \text{(b) }\sum_{j=1}^na_{jk}a_{j\ell}=0&\text{if \(k\neq\ell\).}
    \end{cases}
  \end{equation}
  ...
  the form
  \begin{align*}
    2(a_{11}a_{12}+a_{12}a_{13}+\dotsb+a_{})
  \end{align*}
\end{solution}
\newpage
