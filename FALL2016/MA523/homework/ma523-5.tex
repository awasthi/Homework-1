...
\begin{solution}
  ...
  \begin{align*}
   \frac{\partial}{\partial x_1}\frac{v_\varepsilon}{\varepsilon}
    &=-\frac{x_1}{x_1^2+(x_2+1)^2}
    &\frac{\partial}{\partial x_2}\frac{v_\varepsilon}{\varepsilon}
    &=-\frac{(x_2+1)}{x_1^2+(x_2+1)^2}\\
    \frac{\partial}{\partial x_1}\frac{(v_{\varepsilon})_{x_1}}{\varepsilon}
    &=-\frac{-x_1^2+(x_2+1)^2}{\bigl(x_1^2+(x_2+1)^2\bigr)^2}
    &\frac{\partial}{\partial
      x_2}\frac{(v_{\varepsilon})_{x_2}}{\varepsilon}
    &=-\frac{-x_1^2+(x_2+1)^2}{\bigl(x_1^2+(x_2+1)^2\bigr)^2}
  \end{align*}
