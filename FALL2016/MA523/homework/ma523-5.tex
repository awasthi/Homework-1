...
\begin{solution}
  ...
  \[
    u(x_1,x_2)=\fint_{B_r(x_1,x_2)}}u\diff y
  \]
  for any open \(B_r(x_1,x_2)\subset U\). Then given \((x_1,x_2)\in U\),
  for \(a\) sufficiently large so that \((x_1,x_2)\in U_a\),
  \[
    \sup_{\partial U_a} u\geq u(x_1,x_2).
  \]
\end{solution}
\newpage
