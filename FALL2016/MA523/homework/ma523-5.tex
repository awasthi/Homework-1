...
\begin{solution}
  ...
  By the definition of the supremum, given \(\delta>0\), there exists a
  point \((x_1,x_2)\in U\), such that
  \[
    \sup_U u-\delta<u(x_1,x_2).
  \]
  Choose \(a\) large enough so that \((x_1,x_2)\in U_a\). Then, as we have
  previously demonstrated
  \[
    \sup_U u-\delta<u(x_1,x_2)\leq\sup_{\partial U_a}u\leq\sup_{\partial U}u.
  \]
  In particular,
  \[
    \sup_U u-\delta<\sup_{\partial U}u.
  \]
  Letting \(\delta\to 0\), we obtain
  \[
    \sup_U u\leq \sup_{\partial U}u.
  \]
\end{solution}
\newpage
