...
\begin{solution}
  ...
  \]
  for any \(a\). Let us choose \(a\) large enough so
  \[
    \sup_{\partial U_a}u_\varepsilon=\sup_{\partial U_a} u-\varepsilon\ln a
    \leq%
    \sup_{\partial U}u
  \]
  or
  \[
    \sup_{\partial U_a}u_\varepsilon
    \leq%
    \sup_{\partial U}u+\varepsilon\ln a.
  \]
\end{solution}
\newpage
