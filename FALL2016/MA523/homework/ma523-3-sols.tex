...
\begin{solution*}
  ...
  \(D^{\beta_1,0}u=u_{x^{\beta_1}}=0\) by our previous work. Now suppose
  the proposition is true for all \(\beta_2\leq n-1\), we show the
  proposition holds for \(\beta_2=n\). From our previous work above, we
  have
  \begin{align*}
    D^\beta u
    &=D^{\beta_1,n-1} u_y\\
