...
\begin{solution*}
  ...
  fundamental solutions on \(\bfR^n\) (this follows from the linearity of
...
\begin{problem}
  ...
  \[
    \left\{%
      \begin{aligned}
        ...
        &&\text{for every \(x\in\bfR^n\), \(\lambda>0\),}\\
        \Delta P_k&=0,&\Delta P_m&=0&&\text{in \(\bfR^n\).}
      \end{aligned}
    \right.
  \]
  ...
  \item Show that
    \[
      ...
      \right.
    \]
    where \(B(0,1)=\{\,x\in\bfR^n:|x|<1\,\}\) and \(\nu\) is the outward
    normal
    on \(\partial B(0,1)\).
