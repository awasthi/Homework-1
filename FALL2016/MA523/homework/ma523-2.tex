...
\begin{solution}
  ...
  the inviscid Burger's equation to the right and to the left of \(C\): on
  \(4x+t^2<0\) the equation is trivially satisfied whereas for \(4x+t^2>0\)
  we have,
  \[
    ...
    =0.
  \]
  So \(u\) is indeed a solution to the inviscid Burger's
  equation.
