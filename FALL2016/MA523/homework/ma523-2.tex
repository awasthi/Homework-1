...
\begin{solution}
  ...
  Lastly, we verify that \(u\) satisfies the entropy condition, i.e., that
  \(u_\ell>u_r\) along any shock curve. Fix a point \(x_0\in\bbR\) and let
  \(y>0\). Then, if \(x_0>-t^2/4\), we have
  \begin{align*}
    u(x_0+y,t)-u(x_0,t)
