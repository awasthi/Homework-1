...
\begin{solution}
  ...
  \begin{align*}
    ...
    &\Phi_{xx}(x,t)
    &=\frac{\partial}{\partial x}
      \left(-\frac{x\rme^{-x^2/(4t)}}{2\sqrt{4\pi}t^{\frac{3}{2}}}\right)\\
    &=-\frac{x\rme^{-x^2/(4t)}}{2\sqrt{4\pi}t^{\frac{3}{2}}},
    &&=\frac{x^2\rme^{-x^2/(4t)}}{4\sqrt{4\pi}t^{\frac{5}{2}}}
      -\frac{\rme^{-x^2/(4t)}}{2\sqrt{4\pi}t^{\frac{3}{2}}}
    \\
    &&&=\frac{(x^2-2t)\rme^{-x^2/(4t)}}{4\sqrt{4\pi}t^{\frac{5}{2}}},
  \end{align*}
  and
  \begin{align*}
    \Phi_t(x,t)
  ...
  \begin{align*}
    u(1,t)
    &=\sum_{k=-\infty}^\infty(-1)^k\frac{\rme^{-k^2/(4t)}}{\sqrt{4\pi
      t}}\\
