...
\begin{solution}
  ...
  of favorable sample points: there \(\displaystyle\binom{5}{1}\) ways to
  choose a pair \((\sfL,\sfR)\) and we can arrange them in
  \(2\cdot 3+2\cdot 2+2\cdot 1=12\) ways corresponding to the diagrams
  \begin{align*}
    \sfL\sfR\star\star&&\star\sfL\sfR\star&&\star\star\sfL\sfR\\
    \sfL\star\sfR\star&&\star\sfL\star\sfR\\
    \sfL\star\star\sfR
  \end{align*}
