...
\begin{solution}
  ...
  and
  \[
    A_1\defeq\bigl\{\,\text{exactly \(2\) pairs are among the \(4\)}\,\bigr\}.
  \]
  ...
  \begin{equation}
    ...
    5\cdot 4\cdot 6=120
  \end{equation}
  ways to choose one pair. Taking \eqref{eq:1-2} and \eqref{eq:1-3}, the
  probability that there is at least one complete pair among the four is
  \[
    \#A_1=%
    p(A)=%
    p(A_1)+p(A_2)=%
