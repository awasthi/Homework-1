...
\begin{solution}
  ...
  ways and \(4\) pairs of shoes can be chosen in \(\binom{5}{4}\) ways out
  of which we choose one of \(2\), either a left or a right shoe.

  Thus,
  \[
    P(A)=1-\frac{\binom{5}{4}2^4}{\binom{10}{4}}\approx0.61904.
  \]
\end{solution}
