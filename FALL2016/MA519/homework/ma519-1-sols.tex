...
\text{uniform}
&U[a,b]
&\text{\(\frac{1}{b-a}\) if \(a\leq x\leq b\), else \(0\)}
&\frac{a+b}{2}
&\frac{(b-a)^2}{12}
...
\text{exponential}
&\Exp(\lambda)
&\text{\(\frac{1}{\lambda}\rme^{-\frac{x}{\lambda}}\) for \(x\geq 0\)}
&\lambda
&\lambda^2
&(1-\lambda t)^{-1}
\\
\text{gamma}
&G(\alpha,\lambda)
&\text{\(\frac{\rme^{-\frac{x}{\lambda}}x^{\alpha-1}}
...
\text{chi-squared}
&\chi^2_n
&\text{\(\frac{\rme^{-\frac{x}{2}}x^{\frac{m}{2}-1}}
