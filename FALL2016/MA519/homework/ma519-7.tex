...
\begin{solution}
  ...
  across from their wives. First, we compute the probability that, say, the
  only the first man is seated directly across from his wife. After we have
  made this choice, there are \(20-1\) women left to pair up with men.
\end{solution}
\newpage
