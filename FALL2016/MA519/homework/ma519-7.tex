...
\begin{solution}
  ...
  Now, assuming \(X\sim\Poisson(100,\num{0.05634847900925642})\), the
  ...
  \begin{align*}
    ...
    &=1-P(X<10)\\
    &=1-\sum_{i=1}^9 P(X=i)\\
    &1-e^{-\num{0.05634847900925642}}\sum_{i=1}^9\frac{\num{0.05634847900925642}^i}
      {i!}\\
    &=
  \end{align*}
\end{solution}
...
\begin{solution}
  ...
  \[
    ...
    \lambda^{k_3}k_1!k_2!.
  \]
  Taking the log on the equalities above, we have
  \[
    k_1\ln \lambda \bigl(\sqrt[k_1]{k_2!k_3!}\bigr)=
    k_2\ln \lambda \bigl(\sqrt[k_2]{k_1!k_3!}\bigr)=
    k_3\ln \lambda \bigl(\sqrt[k_3]{k_1!k_2!}\bigr)=
  \]
\end{solution}
\newpage
