...
\begin{solution}
  ...
  distributing \(\heartsuit\)s to the four players. By Feller's solution to
  the occupancy problem, there are \(\displaystyle\binom{13+4-1}{13}\) ways
  to distribute \(13\) hearts to four people.
\end{solution}
\newpage
