...
\begin{solution}
  ...
  Now we count the sample points in \(\Omega\setminus A\): There are \(3\)
  ways for the first man to get back a watch other than his own. For the
  second man, either the first man picked his watch or he did not. In the
  first case, there are \(3\) ways for him to get back a watch not his own,
  whereas in the second only \(2\) ways.
\end{solution}
\newpage
