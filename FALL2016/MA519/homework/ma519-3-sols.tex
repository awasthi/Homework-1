...
\begin{solution*}
  ...
  For part (b): Let \(A_k\) denote the event ``the \(k\)\textsup{th} time
  we pick up a pair of sticks, there is one short and one long stick.''
  First let us examine the probability of \(A_1\). It is easy to see that
  \(P(A_1)=\)
\end{solution*}
