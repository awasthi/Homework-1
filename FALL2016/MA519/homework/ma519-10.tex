...
\end{problem}
\begin{solution}
  First, let us find the PDF of the random variable \(X_i^2\). Via a
  ...
  Thus, the PDF of \(X_i^2\) is
    \begin{align*}
      f_{X_i^2}(x)
      &=\frac{\varphi(\sqrt{x})}{2\sqrt{x}}+\frac{\varphi(-\sqrt{x})}{2\sqrt{x}}
        \intertext{which, since \(\varphi\) is even, becomes}
      &=x^{-1/2}\varphi(\sqrt{x})\\
      &=\frac{\rme^{-x^2/2}}{\sqrt{2\pi x}}.
    \end{align*}
\end{solution}
\newpage
