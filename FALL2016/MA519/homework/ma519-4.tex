...
\begin{solution}
  ...
  \[
    A_i=\bigl\{\,\text{roll of the die came up \(i\)}\,\bigr\},%
    \quad%
    1\leq n\leq 6.
  \]
  Note that the \(A_n\) are not necessarily disjoint events. Now, define a
  random variable \(X\colon\Omega\to\bfR\) by setting
  \(X(\omega)=\sum_{n=1}^6\chi_{A_n}(x)\) where \(\chi_{A_n}(x)=1\) if
  \(x\in A_n\), and \(\chi_{A_n}(x)=0\) otherwise.
