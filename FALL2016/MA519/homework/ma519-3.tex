...
\begin{solution}
  ...
  \(\Omega\).
  \begin{quote}
    There are \(2n\) ways to chose the first half of a stick and \(2n-1\)
    ways to chose the second. Therefore,
    \[
      \card\Omega=2n(2n-1).
    \]
  \end{quote}
  Next we count the number of sample points in \(A\).
  \begin{quote}
    Make an initial choice for the first part, with
  \end{quote}
\end{solution}
\newpage
