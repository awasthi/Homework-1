...
\end{problem}
\begin{solution}
  Let let \(A\) denote the event that a coin with a head is chosen and
  \(B\) denote the event that for a given coin its other side is a tail. By
  the total probability formula,
  \begin{align*}
    P(B)
    &=P(B|A)P(A)+P(B|\lnot A)P(\lnot A)\\
    &=\frac{3}{5}P(B|A)+\frac{2}{5}
  \end{align*}
\newpage
