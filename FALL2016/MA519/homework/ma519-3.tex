...
\begin{solution}
  ...
  that two parts are joined in their original order. We have \(2n\) to
  chose one end and once we have done that, only \(1\) way to chose the
  complementary end. Thus,
  \[
    P(A)=\frac{2n\cdot 1}{2n(2n-1)}=\frac{1}{2n-1}.
  \]

  For part (b), the sample space \(\Omega\) is as before. Let \(A\) denote
  the event that each long part is joined with a short part
\end{solution}
\newpage
