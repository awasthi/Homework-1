...
\begin{solution}
<<<<<<< HEAD
  For part (a): let \(\Omega\) denote the sample space and let \(A\) denote
  the event that two parts of the broken sticks are paired together in
  their original order. First, we count the number of sample points in
  \(\Omega\). There are \(2n\) ways to chose the first half of a stick and
  \(2n-1\) ways to chose the second. Therefore,
  \[
    \#\Omega=2n(2n-1).
  \]
  Next we count the number of sample points in \(A\). Once we make a choice
  from among the \(2n\) broken sticks,
=======
  ...
  \(2n/2n(2n-1)\)
>>>>>>> ac722b3bb15c346855f29af21ac552cf7f679f1a
\end{solution}
\newpage
