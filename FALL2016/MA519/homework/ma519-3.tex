...
\begin{solution}
  ...
  \(\#\Omega=2n(2n-1)\) ways to pair the sticks together. Let \(A\) denote
  the event that two parts are joined in their original order. We have
  \(2n\) ways to chose one end and, once we have made that choice, only
  \(1\) way to chose the complementary end. Thus,
  \[
    \calP P(A)=\frac{2n\cdot 1}{2n(2n-1)}=\frac{1}{2n-1}.
  \]
