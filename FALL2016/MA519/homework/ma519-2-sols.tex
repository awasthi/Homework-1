...
\begin{solution*}
  ...
  people fall in twelve different calendar months. After labeling the
  people ``person \(k\)'', where \(k=1,\dotsc,12\), we make the following
  counting argument. Person 1 can choose any one of \(12\) months.
\end{solution*}
