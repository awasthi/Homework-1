...
\begin{solution}
  ...
  explicitly
  \begin{align*}
    p(2)&=\frac{2}{6}\cdot\frac{1}{5}=\frac{1}{15},
    &p(3)&=\frac{4}{6}\cdot\frac{2}{5}\cdot\frac{1}{4}+\frac{2}{6}\cdot\frac{4}{5}\cdot\frac{1}{4}
           =\frac{2}{15},\\
    p(4)&=3\cdot\frac{4}{6}\cdot\frac{3}{5}\cdot\frac{2}{4}\cdot\frac{1}{3}
          =\frac{3}{15},
    &p(5)&=4\cdot\frac{4}{6}\cdot\frac{3}{5}\cdot\frac{2}{4}
           \cdot\frac{2}{3}\cdot\frac{1}{2}
           =\frac{4}{15},\\
    p(6)&=5\cdot\frac{4}{6}\cdot\frac{3}{5}\cdot
