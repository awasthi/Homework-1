...
\begin{solution}
  ...
  by
  \begin{align*}
    P(X=1)&=\frac{1}{4}\cdot\frac{2}{3}\cdot\frac{1}{2}=\frac{1}{12},
    &P(X=2)&=\frac{1}{4}\cdot\frac{1}{3}\cdot\frac{1}{2}=\frac{1}{24},\\
    P(X=3)&=\frac{1}{4}\cdot\frac{1}{3}\cdot\frac{1}{2}\cdot 0=0,
    &P(X=4)&=\frac{1}{4}\cdot\frac{1}{3}\cdot\frac{1}{2}\cdot 1=\frac{1}{24}.
  \end{align*}
