...
\begin{solution}
  ...
  \begin{align*}
    ...
    p(3)&=\frac{2}{4}\cdot\frac{3}{5}=\frac{3}{10},
    &p(4)&=\frac{2}{3}\cdot\frac{2}{4}=\frac{1}{3},\\
    p(5)&=\frac{1}{3}.
  \end{align*}
  Thus,
  \begin{align*}
    E(X)
    &=\frac{1}{3}+2\cdot \frac{4}{15}+3\cdot\frac{3}{10}
      +4\cdot\frac{1}{3}+5\cdot\frac{1}{3}\\
    &=\frac{10+16+27+40+50}{30}\\
    &=\frac{143}{30}\\
    &\approx\num{4.766666666666667}.
  \end{align*}

  Similarly, we have
  \begin{align*}
    E(X^2)
    &=\frac{1}{3}+2^2\cdot \frac{4}{15}+3^2\cdot\frac{3}{10}
      +4^2\cdot\frac{1}{3}+5^2\cdot\frac{1}{3}\\
    &=\frac{10+32+81+160+250}{30}\\
    &=\frac{533}{30}\\
    &\approx\num{17.766666666666666}.
  \end{align*}
\end{solution}
\newpage
