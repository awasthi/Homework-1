...
\begin{solution}
  ...
  \begin{equation}
    ...
    \text{ as \(n\to\infty\).}
  \end{equation}
  Let \(\varphi(x)\defeq x-c\) and let \(g_n\) denote the PDF of \(X_n-c\). By
  ...
  \]
  By Hölder's inequality for \(\beta\) and \(\gamma\) positive real numbers
  such that \(\beta^{-1}+\gamma^{-1}=\alpha\)
