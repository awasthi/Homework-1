...
\begin{solution}
  ...
  \(P(|X_n-c|>\varepsilon)\to 0\). Therefore, \(X_n\) converges to \(c\) in
  probability.

  For part (b), suppose \(a_n(X_n-\theta)\) converges to a \(N(0,1)\) in
  law. Then with the additional assumption that
