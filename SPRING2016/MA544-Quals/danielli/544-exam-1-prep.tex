...
\]
Here
$B(\mathbf{0},r)\coloneqq\left\{\,\bfy\in\bfR^n:|\bfy|<r\,\right\}$. Prove
...
E\coloneqq\left\{\,x:\text{$\lim_{k\to\infty} f_k(x)$ exists}\,\right\}
\end{equation}
...
$\Gamma\coloneqq\left\{x_k\right\}_{k=1}^N$ be a partition of $[a,b]$ into closed
