...
\[
\int_{\bfR^n\setminus B_\varepsilon(\mathbf{0})}f(\bfx) d \bfx\leq\frac{C}{\varepsilon}.
\]
\end{problem}
\begin{proof}
...
Put $E=\bfR^n\setminus B_\varepsilon(\mathbf{0})$. Then, to show that
...
$N\in\bbN$. Moreover, we are given convergence in $L(\bfR^n)$ of $f_k$ to
$f$
\begin{equation}
