...
nonnegative. For assume otherwise then there exists a point $\bfx$ in
$\bbR^n$ such that $f(\bfx)<0$. But $f_k(\bfx)\geq 0$ for all
$k\in\bbN$. Set $\varepsilon>f(\bfx)$ then we have
\begin{equation}
