...
\begin{aligned}
\Gamma(f,E)&=\left\{\,(\bfx,f(\bfx))\in\bfR^{n+1}:\text{$\bfx\in
    E$, $f(\bfx)<\infty$}\,\right\},\\
R(f,E)&=\left\{\,(\bfx,y)\in\bfR^{n+1}:\text{$\bfx\in E$, $0\leq
...
\int_E f(\bfx) d \bfx=|R(f,E)|_{\bfR^{n+1}}.
\end{equation}
...
$E$ of $\bfR^{n+m}$, and let $E_\bfx=\left\{ \,\bfy:(\bfx,\bfy)\in
  E \,\right\}$.
\begin{enumerate}[label=\textnormal{(\roman*)}]
...
\[
(f*g)(\bfx)=\int_{\bfR^n}f(\bfx-\bfy)g(\bfy) d \bfy,
\]
