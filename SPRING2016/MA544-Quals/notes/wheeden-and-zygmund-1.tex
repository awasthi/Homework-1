...
\begin{align*}
V[cf;a,b]
&=\sup_\Gamma\sum_{x_i\in\Gamma}|cf(x_i)-f(x_{i-1})|\\
&=|c|\sup_\Gamma\sum_{x_i\in\Gamma}|f(x_i)-f(x_{i-1})|\\
&=|c|V_f\\
&<\infty.
\end{align*}
...
\begin{align*}
V[f+g;a,b]
&=\sup_\Gamma\sum_{x_i\in\Gamma}|(f+g)(x_i)-(f+g)(x_{i-1})|\\
&=\sup_\Gamma\sum_{x_i\in\Gamma}\left|{(f(x_i)-f(x_{i-1}))}+{(g(x_i)-g(x_{i-1}))}\right|\\
&\leq\sup_\Gamma\sum_{x_i\in\Gamma}\bigl[|f(x_i)-f(x_{i-1})|+|g(x_i)-g(x_{i-1})|\bigr]\\
&=\sup_\Gamma\sum_{x_i\in\Gamma}|f(x_i)-f(x_{i-1})|
+\sup_\Gamma\sum_{x_i\in\Gamma}|g(x_i)-g(x_{i-1})|\\
&=V_f+V_g\\
&<\infty.
\end{align*}
...
\begin{align*}
V[fg;a,b]
&=\sup_\Gamma\sum_{x_i\in\Gamma}|(fg)(x_i)-(fg)(x_{i-1})|\\
&=\sup_\Gamma\sum_{x_i\in\Gamma}|f(x_i)g(x_i)-f(x_{i-1})g(x_{i-1})|\\
&=\sup_\Gamma\sum_{x_i\in\Gamma}|f(x_i)g(x_i)-f(x_{i-1})g(x_i)+f(x_{i-1})g(x_i)-f(x_{i-1})g(x_{i-1})|\\
&=\sup_\Gamma\sum_{x_i\in\Gamma}|(f(x_i)g(x_i)-f(x_{i-1})g(x_i))
-(f(x_{i-1})g(x_{i-1})-f(x_{i-1})g(x_i))|\\
&=\sup_\Gamma\sum_{x_i\in\Gamma}|g(x_i)||f(x_i)-f(x_{i-1})|
+\sup_\Gamma\sum_{x_i\in\Gamma}|f(x_{i-1})||g(x_i)-g(x_{i-1})|
...
&<\infty.
\end{align*}
Hence, $fg$ is of bounded variation on $[a,b]$.
\end{proof}
