...
and define a homotopy $H\colon I\times\GL_n(\bfR)\to\GL_n(\bfR)$ by mapping
the pair $(t,A)\mapsto g(t,A)$. Continuity of $H$ follows from the fact
that $H$ it is multiplication in $\bfR^n$ followed by a linear
mapping. It's not hard to see that $H$ stays in $\GL_n(\bfR)$ for all $t$
and $H(1,A)$ is in $\Orth_n(\bfR)$.
...
either $\det f=1$ or $-1$. Suppose it is the former. Then
\end{proof}
\newpage
