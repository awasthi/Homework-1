...
0$. Following the hint, we aim to construct a chain homotopy $P\colon
C_*(\bfR^n)\to C_*(\bfR^n)$ such that $\partial\circ
P+P\circ\partial=f_\#+g_\#$ where $g_\#$ has a matrix representation with
$\pm 1$'s in the diagonal.
\end{proof}
\newpage
