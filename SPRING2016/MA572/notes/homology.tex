...
generates a free action of $\bbZ/2\bbZ$.
...
into a neighborhood $V$ of $y$. Then $f(U_i\setminus\{x_i\})\subset
V\setminus\{y_i\}$ for each $i$, and we have a commutative diagram
\[
...
$H_n(S^n)\cong\bbZ$, and the top homomorphism $f_*$ becomes multiplication
