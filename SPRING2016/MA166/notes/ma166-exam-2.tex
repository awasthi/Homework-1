...
\begin{problem}[{\color{Red} \# 1}, {\color{Green} \# 12}]
...
\begin{problem}[{\color{Red} \# 2}, {\color{Green} \# 4}]
...
\begin{problem}[{\color{Red} \# 3}, {\color{Green} \# 5}]
Evaluate the integral
\[
...
\begin{problem}[{\color{Red} \# 4}, {\color{Green} \# 10}]
...
\begin{problem}[{\color{Red} \# 5}, {\color{Green} \# 11}]
Which of the following statements are true?
\begin{enumerate}[label=(\MakeUppercase{\roman*})]
...
\begin{problem}[{\color{Red} \# 6}, {\color{Green} \# 2}]
Evaluate the integral
...
\begin{problem}[{\color{Red} \# 7}, {\color{Green} \# 6}]
Evaluate the integral
\[
...
\begin{problem}[{\color{Red} \# 8}, {\color{Green} \# 7}]
...
\begin{problem}[{\color{Red} \# 9}, {\color{Green} \# 8}]
The curve
\[
...
\begin{problem}[{\color{Red} \# 10}, {\color{Green} \# 9}]
...
\begin{problem}[{\color{Red} \# 11}, {\color{Green} \# 1}]
Evaluate the integral
\[
...
\begin{problem}[{\color{Red} \# 12}, {\color{Green} \# 3}]
