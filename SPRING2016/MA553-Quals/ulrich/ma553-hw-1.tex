...
\end{problem}
\begin{proof}
Suppose $a\in G$ is an element of order $m$, and consider $a^n$. By the
fundamental theorem of arithmetic, there exists $q$ and $r$ positive
integers such that $m=qn+r$ with $r<n$. Hence, we have
\[
a^m=a^{qn+r}=a^{qn}a^r=a^r
\]
\end{proof}
