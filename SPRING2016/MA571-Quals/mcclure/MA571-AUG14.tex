...
\begin{problem}
Let $D$ be the closed unit disk in $\bbR$ ${\bbR}^2$, that is, the set
\[
...
form $U=X\setminus C$ containing the point at infinity, $\infty$, where $C$ is
...
calculate $\pi_1\left(\bbR^2\setminus\{a,b\},x_0\right)$. You may not use any other
method.
\end{problem}
\begin{proof}
...
convex set. Moreover, note that $U\simeq\bbR^2\setminus\{x_0\}$ and
$V\simeq\bbR^2\setminus\{x_0\}$ (in the case of $U$, first consider the
...
$\pi_1(U,x_0)\cong\pi_1\left(\bbR^2\setminus\{x_0\},y_0\right)\cong\bbZ$ for some
