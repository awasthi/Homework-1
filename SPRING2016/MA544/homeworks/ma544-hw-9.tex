...
\item Let $E$ be a measurable subset of $\bfR^2$ such that for almost every
  $x\in\bfR^1$, $\left\{\,y\;\middle|\;(x,y)\in E\,\right\}$ has
  $\bfR^1$-measure zero. Show that $E$ has measure zero and that for almost
  every $y\in\bfR^1$, $\left\{\,x\;\middle|\;(x,y)\in E\,\right\}$ has
  measure zero.
\item Let $f(x,y)$ be nonnegative and measurable in $\bfR^2$. Suppose that
  for almost every $y\in\bfR^1$, $f(x,y)$ is finite for almost every
...
Let $F$ be a closd subset of $\bfR^1$ and let $\delta(x)=\delta(x,F)$ be
...
\[
\int_{\bfR^1}\frac{\delta^\lambda(y)f(y)}{\left|x-y\right|^{1+\lambda}}\;dt
\]
