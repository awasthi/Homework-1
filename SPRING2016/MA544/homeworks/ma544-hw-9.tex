...
\end{problem}
\begin{proof}
(a) Let $\chi_E$ be the characteristic function of $E$. By Fubini's
theorem, we have
\begin{equation}
\label{eq:application-of-fubinis}
\iint_E\chi_E\;dxdy=\int_{E_1}\left[\int_{E_2} dy\right]\;dx=\lambda(E_1)\lambda(E_2).
\end{equation}
\\\\
(b)
\end{proof}
