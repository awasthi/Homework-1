...
Prove the converse of Hölder's inequality for $p=1$ and $\infty$. Show Show
also that for $1\leq p\leq\infty$, a real-valued measurable $f$ belongs to
...
\begin{problem}[Wheeden \& Zygmund {\S}8, Ex.\@ 9]
  % 9. If f is real-valued and measurable on E, |E| > 0, define its essential
  % infimum on E by ess inf f = sup{α : |{x ∈ E : f (x) < α}| = 0}. E If f ≥
  % 0, show that essE inf f = (essE sup 1/f )−1 .
