...
\end{problem}
\begin{proof}
By the commentary at the end of the proof of Theorem 8.8, it appears that
we must prove the following: if $1\leq p\leq\infty$, then a measurable
function $f$ belongs to $L^p(E)$ if $fg\in L^1(E)$ for every $g\in
L^{p'}(E)$, $1/p+1/p'=1$.

Recall that by convention, if $p=1$ its conjugate exponent, $p'$, is
