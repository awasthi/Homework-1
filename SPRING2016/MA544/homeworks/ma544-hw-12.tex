...
\end{problem}
\begin{proof}
Let $f$ be a measurable function such that $|f|\leq M$ for some positive real
number $M$. We will show that, for $p=1$ and $p=\infty$, if $\|fg\|_1\leq
M\|g\|_{p'}$, there exists
\end{proof}
\newpage
