...
\(U\subseteq\bfR^3\) be an open set. In calculus class, we learn about
operations
\[
  \{\,\text{functions}\,\}
  \xrightarrow{\,\nabla\,}
...
\(v\) is a gradient? Answer: sometimes yes (e.g.\@ if \(U=\bfR^3\)) and
sometimes no (e.g.\@ if \(U=\bfR^3\) minus a line).
