...
\[
  \includegraphics{ext-thm-b-surj}
\]
...
\begin{proof}
  ...
  \(m_i\)\textsup{th} copy of \(R\). This gives a splitting of
...
Notethat in the usual approach, it is not a priori clear that
