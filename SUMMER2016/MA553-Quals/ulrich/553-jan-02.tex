...
\begin{solution}
  ...
  index $[G:N]\leq |S_n|=n!$ and $N\subseteq H$ since $g\in N$ if and only if
  $gg_iH=g_iH$ which, in particular, implies that $gH=H$. Thus, $N\subseteq
  H$ and $[G:N]<\infty$.
\end{solution}
...
\begin{solution}
  ...
  $3$. If the number of $2$-Sylow subgroups is $1$, then
  $P\trianglelefteq G$ and the quotient $G/P$ has order $[G:P]=3$, hence,
  is cyclic. Moreover, since $P$ is a $p$-group, it is solvable. Since $P$
  and $G/P$ are solvable, $G$ is solvable.
