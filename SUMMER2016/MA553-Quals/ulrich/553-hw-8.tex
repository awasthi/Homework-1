...
\begin{problem}
Let $k$ be a field, $f\in k[X]$ is a polynomial of degree $n\geq 1$, and
$K$ the splitting field of $f$ over $k$. Show that $[K:k]\mid n!$.
\end{problem}
\begin{proof}
\end{proof}
...
k[X]$ by $\Delta_n\bigl(\sum a_iX^i\bigr)\coloneqq\sum
...
\begin{problem}
Let $k\subset K$ be a finite filed extension. Show that $k$ is perfect if
...
$k\coloneqq\bfZ/p\bfZ$. Show that $k\subset K$ is normal, separable, of
degree $p$.
\end{problem}
\begin{proof}
\end{proof}
