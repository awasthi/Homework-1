...
$n$ so that $\bbQ\subseteq\bbQ(\rho)$ is cyclic.
\end{problem}
\begin{solution}
\end{solution}
...
\begin{enumerate}[label=(\alph*),noitemsep]
\item For $k\subseteq L\subseteq K$ show that $\Gal(K/L)$ is
...
\item For $k\subseteq L\subseteq K$ with $k\subseteq L$ normal show
  ...
  $\Gal(K/k)$ is solvable.
\item For $k\subseteq L$ with $K$ and $L$ in a common field show
