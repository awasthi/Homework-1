...
\begin{tabular}{cl}
  ...
  $\bfF_q$ & is the finite field of order $q=p^n$ for some prime $p$\\
  $\bfZ$   & is the set of the integers\\
  $\bfN$   & is the set of the natural numbers $1,2,\dotsc$\\
...
\begin{solution}
  ...
  for some $k\in\bfZ^+$. Now, since $(m,n)\mid m$ and $(m,n)\mid n$, we can
