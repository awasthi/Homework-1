...
\end{problem}
\begin{solution}
  % Suppose \(\card G=p^2q\). Let us first consider the \(q\)-Sylow subgroups
  % of \(G\). If \(p<q\) and \(1\nequiv p^2\pmod{q}\) then \(G\) contains a
  % single \(q\)-Sylow subgroup \(Q\) which implies \(Q\trileq
  % G\). Otherwise, \(G\) contains \(p^2\) \(q\)-Sylow subgroups so, counting
  % the number of elements of order \(q\) in \(G\), we have
  % \(p^2(q-1)=p^2q-p^2\) elements remaining; this leaves room for exactly
  % one \(p\)-Sylow subgroup \(P\) which implies that \(P\trileq
  % G\). Otherwise, \(p>q\) and \(1\equiv p\pmod{q}\) so \(G\) may contain
  % \(p\) \(q\)-Sylow subgroups. However, \(1\equiv p\pmod{q}\) implies
  % \(p=kq+1\) which implies that the number of \(p\)-Sylow subgroups must be
  % \(1\).
