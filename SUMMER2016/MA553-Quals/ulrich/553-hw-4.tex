...
\begin{problem}
  Let \(p\) be a prime and let \(G\) be a nonAbelian group of order
  \(p^3\). Show that \(G'=Z(G)\).
\end{problem}
\begin{solution}
\end{solution}
...
\begin{problem}
  Let \(p\) be an odd prime and let \(G\) be a nonAbelian group of order
  \(p^3\) having an element of order \(p^2\). Show that there exists an
