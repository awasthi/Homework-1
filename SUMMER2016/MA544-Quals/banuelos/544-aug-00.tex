...
\begin{solution}
  ...
  For part (i) $\impliedby$ seeking a contradiction suppose that every
  subsequence $\{f_{n_k}\}$ contains a subsequence $\{f_{n_{k_\ell}}\}$
  that converges almost everywhere to $f$ but that for some
  $\varepsilon>0$,
  \[
    \lim_{n\to\infty}\mu%
    \left(%
