...
\begin{solution}
  ...
  everywhere to $f$. Then the set
  \[
    E=\left\{\,x\in X:\limsup_{n_{k_\ell}\to\infty} f_{n_{k_\ell}}\neq\,\right\}
  \]
\end{solution}
...
\begin{problem}
  ...
  \item If $f_n\leq g_n$ almost everywhere for every $n$, prove that
    ...
    \]
    and let $\{g_{n_{k_\ell}}\}$ be a subsequence of $\{g_{n_k}\}$ such
    that $g_{n_{k_\ell}}\to g$ almost everywhere.]
