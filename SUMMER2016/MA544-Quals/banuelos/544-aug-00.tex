...
\begin{solution}
  ...
  \begin{proof}[Proof of claim]
    ...
    $\varepsilon,\delta>0$ be given.Here is where the assumption that
    $\mu(X)<\infty$ is essential! By Egorov's theorem, there is a
    measurable subset $E\subseteq X$ with $\mu(X\setminus E)<\delta$ such
