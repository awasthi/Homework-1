...
\begin{problem}
  ...
  $g_n(x)=f(x)\chi_{\left\{\,f_n\leq M\,\right\}}(x)$ satisfy
...
\end{problem}
\begin{solution}
  Seeking a contradiction, suppose that $E$ is a subset of $X$ with
  $\mu(E)>0$ such that $\sum_{n=1}^\infty f_n(x)=\infty$ for every $x\in
  E$.
\end{solution}
