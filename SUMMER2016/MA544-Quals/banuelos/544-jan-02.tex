...
\begin{solution}
  ...
  $\varepsilon>0$ there exists a $h_0>0$ such that $|h|<h_0$ implies
  \[
    \left|\frac{f(x+h)-f(x)}{h}-f'(x)\right|<\varepsilon
  \]
  for any $x\in[0,1]$ such that $x+h\in[0,1]$. Fix $x\in[0,1]$ such that
  $x+h\in[0,1]$. Then, we want to show that there exists $\delta>0$ such
  that $y\in B(x,\delta)$ implies
  \[
