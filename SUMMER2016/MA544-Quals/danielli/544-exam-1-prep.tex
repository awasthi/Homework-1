...
\end{problem}
\begin{proof}
No, but I don't care enough to come up with a explicit counterexample. The
counterexample should go as follows: Construct a nonmeasurable set $E$ on
$\bbR$ and define $f\coloneqq\chi_E$
\end{proof}
