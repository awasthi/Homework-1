...
\begin{tabular}{cl}
  ...
  $\bfR^+$ & is the set of positive real numbers, that is, $x\in\bfR$ with
             $x\geq 0$\\
  ...
  $\|\blank\|$ & the standard Euclidean norm on $\bfR^n$\\
...
\begin{solution}
  ...
  Let $f\colon[a,b]\to\bfR$ be a function of bounded variation on $[a,b]$
...
\begin{solution}
  ...
  exists $N\in\bfN$ such that $n\geq N$ implies $|\Gamma_n|<\delta$. Then,
...
\begin{solution}
  ...
  to $\Gamma$ give us the chain of inequalities
  \begin{align*}
    ||c|I-R_\Gamma'|
    &=\left| |c|I-
