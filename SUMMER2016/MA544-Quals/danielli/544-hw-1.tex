...
\begin{proof}
 ...
 continuous on $[0,1]$ but that, nevertheless, $f$ is not of \gls{bv} on
 $[0,1]$.
 ...
 to show that $\lim_{x\to 0}f(x)=0$. Consider the sequence $\{1/k\}$. This
 sequence converges to $0$. Moreover, given $\varepsilon>0$, by the
 Archimedean principle, for sufficiently large $K$, the inequality
 $1/K<\varepsilon$ holds so for every $k\geq K$ we have
% \begin{equation}
% \label{eq:1:1}
% |{(1/k)\sin(k)-0}|\leq
% |1/k|<\varepsilon.
