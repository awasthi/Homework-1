...
\begin{problem}[Wheeden \& Zygmund Ch.\@ 3, Ex.\@ 12]
  If \(E_1\) and \(E_2\) are measurable sets in \(\bbR^1\), show
  \(E_1\times E_2\) is a measurable subset of \(\bbR^2\) and
  \(m(E_1\times E_2)=m(E_1)m(E_2)\). (Interpret \(0\cdot\infty\) as \(0\).)
  [\emph{Hint:} Use a characterization of measurability.]
\end{problem}
\begin{solution}
