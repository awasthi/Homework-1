...
\end{problem}
\begin{solution}
  Part (a) is a special case of the Riesz representation theorem (perhaps
  looking at this problem as a problem in functional analysis helps shed
  some light on its proof): define the inner product
  \(\langle\cdot,\cdot\rangle\colon L^2(E)\times L^2(E)\to\bbR\) by
  \[
    \langle f,g \rangle=\int_E fg\diff x.
  \]
  Then, we have
  \begin{align*}
    {\|f-f_n\|_2}^{\!2}
