...
\begin{solution}
  ...
  \begin{align*}
    ...
    &\leq\int_\bbR
      \biggl[
      {\|f\|_p}^{\!r-p}{\|g\|_q}^{\!r-q}\int_\bbR|f(y)|^p|g(x-y)|^q\diff y
      \biggr]\\
    &={\|f\|_p}^{\!r-p}{\|g\|_q}^{\!r-q}\iint\limits_{\bbR\times\bbR}|f(y)|^p|g(x-y)|^q\diff
      y\\
    &={\|f\|_p}^{\!r-p}{\|g\|_q}^{\!r-q}\int_\bbR|f(y)|^p\biggl[\int_\bbR
      |g(x-y)|^q\diff y\biggr]\rmd x\\
    &\leq{\|f\|_p}^{\!r-p}{\|g\|_q}^{\!r-q}{\|f\|_p}^{\!p}{\|g_q\|}^{\!q}\\
    &={\|f\|_p}^{\!r}{\|g\|_q}^{\!r}.
  \end{align*}
