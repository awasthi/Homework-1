...
\begin{solution}
  ...
  For part (b), (to reiterate) we want to show that
  \[
    |(f*g)(x)|^r\leq{\|f\|_p}^{\!r-p}{\|g\|_q}^{\!r-q}\int|f(y)|^p|g(x-y)|^q\diff y
  \]
  Applying the generalized Hölder's inequality we proved in part (a),
  \begin{align*}
    |f*g|
    ...
    &={\|f\|_p}^{\!r-p}{\|g\|_q}^{\!r-q}\int|f(y)|^p|g(x-y)|^q\diff y.
  \end{align*}
\end{solution}
