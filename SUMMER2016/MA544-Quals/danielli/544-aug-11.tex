...
\begin{problem}
A bounded function $f$ is said to be of bounded variation on $\bfR$ if it
...
\]
\item $\displaystyle\left|\int_{\bfR} f(x)\varphi'(x)\diff x\right|\leq A$,
...
\item Prove \emph{Young's convolution theorem}: Assume that $p$, $q$, $r$,
  $f$, and $g$ are as in part (b). Then $f*g\in L^r(\bfR)$ and
  \[
