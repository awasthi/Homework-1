\section{Danielli: Summer 2011}
\begin{problem}
Let $f\in L^1(\bbR)$, and let $F(t)\coloneq\int_\bbR f(x)\cos(tx)\diff x$.
...
$A\coloneq\sup_{a,b}V[a,b;f]<\infty$. Here, $V[a,b;f]$ denotes the total
...
\]
\\\\
(Recall that $(f*g)(x)\coloneq\int f(y)g(x-y)\diff y$.)
