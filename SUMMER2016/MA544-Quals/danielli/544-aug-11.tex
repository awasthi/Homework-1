...
\end{problem}
\begin{solution}
  Part (a) is a special case of the Radon--Riesz representation
  theorem. Let \(\varepsilon>0\) be given. Then, since
  \(\|f_n\|_2\to\|f\|_2\), there exists an index \(N'\in\bbN\) such that
  \(n\geq N'\) implies
  \[
    \bigl|%
    \|f_n\|_2-\|f\|_2%
