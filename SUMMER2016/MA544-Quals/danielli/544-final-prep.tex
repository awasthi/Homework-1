\subsection{Final Exam Practice Problems}
\begin{problem}
Suppose $f\in L^1(\bfR^n)$ and that $x$ is a point in the Lebesgue set of
$f$. For $r>0$, let
\[
...
\begin{problem}
Let $E\subset\bfR^n$ be a measurable set, $1\leq n<\infty$. Assume
...
\begin{problem}
Let $f\in L(\bfR)$, and let $F(t)\coloneqq\int_{\bfR}f(x)\cos(tx)dx$.
\begin{enumerate}[label=(\alph*),noitemsep]
