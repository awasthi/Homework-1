...
$B_\varepsilon\coloneq B(\mathbf{0},\varepsilon)$. Consider
...
\end{equation}
Set $C\coloneq|S^{n-1}|_{\bbR^{n-1}}$. Putting equations
...
f=\infty$ and $\lim_{k\to\infty}f_k=\infty$. However, if $E\coloneq(-1,1)$
