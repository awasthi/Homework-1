...
\begin{solution}
  ...
  \begin{align*}
    ...
    &=\int_\varepsilon^\infty
      \frac{1}{r^{n+1}}
      \Biggl[\int_{S^{n-1}(\mathbf{0},r)}\rmd\sigma\Biggr]\rmd r
      \intertext{which, by a problem from the homework, becomes}
    &=C_n\int_\varepsilon^\infty r^{n-1}\biggl[\frac{1}{r^{n+1}}\biggr]\rmd
      r\\
...
\end{problem}
\begin{solution}
  Let \(E\) be a measurable subset of \(\bbR^n\). By Fatou's lemma, we have
