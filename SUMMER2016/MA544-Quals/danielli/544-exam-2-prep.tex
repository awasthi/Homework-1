...
\begin{solution}
  ...
  \begin{equation}
    ...
    \begin{aligned}
      ...
      +\liminf_{n\to\infty}\int\limits_{\mathclap{\bbR^n\setminus E}}f_n\diff x &\leq%
      \int_{\bbR^n}f\diff x\\
      &= \int_E f\diff x
      +\int\limits_{\mathclap{\bbR^n\setminus E}}f\diff x\\
      &\leq \limsup_{n\to\infty}\int_E f_n\diff x
      +\limsup_{n\to\infty}\int\limits_{\mathclap{\bbR^n\setminus E}}f_n\diff x.
    \end{aligned}
  \end{equation}
...
\intertext{and}
  ...
  \(\lim_{n\to\infty}\int_{\bbR^n}f_n\diff x<\infty\).
\end{solution}
