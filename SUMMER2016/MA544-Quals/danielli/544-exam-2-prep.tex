...
\[
\int_{\bfR^n\setminus B(\mathbf{0},\varepsilon)}f(\bfx) \diff \bfx\leq\frac{C}{\varepsilon}.
\]
\end{problem}
\begin{solution}
...
\label{eq:prep:2:2}
\begin{aligned}
\int_{\bfR^n\setminus B_\varepsilon}f(\bfx)\diff\bfx
&=\int_{\bfR^n\setminus B_\varepsilon} f(\bfx)\diff\bfx\\
&=\int_{\bfR^n\setminus
...
\end{equation}
Set $C=|S^{n-1}|_{\bfR^{n-1}}$. Putting equations
...
$E$ and $\bfR^n\setminus E$. To prove that the limit of the sequence
...
\begin{equation}
  \label{eq:prep:2:8}
\int_{\bfR^n\setminus E}f=\int_{\bfR^n\setminus
  E}\liminf_{k\to\infty}f\leq\liminf_{k\to\infty}\int_{\bfR^n\setminus E}f_k.
\end{equation}
...
\label{eq:prep:2:9}
\begin{aligned}
\int_Ef=\int_{\bfR^n}f-\int_{\bfR^n\setminus E}f
&\geq\limsup_{k\to\infty}\int_{\bfR^n}f-\liminf_{k\to\infty}\int_{\bfR^n\setminus
E}f_k\\
&\geq\limsup_{k\to\infty}\int_{\bfR^n}f_k-\limsup_{k\to\infty}\int_{\bfR^n\setminus
  E}f_k\\
&=\limsup_{k\to\infty}\left[\int_{\bfR^n}f_k-\int_{\bfR^n\setminus
    E}f_k\right]\\
