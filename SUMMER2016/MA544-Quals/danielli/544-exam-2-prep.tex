...
\begin{solution}
  ...
  \]
  where \(E_n=\bigl\{\,x\in E:f(x)\geq n\,\bigr\}\). Then, by the
  definition of the Lebesgue measure,
  \[
    \sum_{n=1}^\infty m(E_n)=\sum_{n=1}^\infty\int_\bbR
    \indicate_{E_n}(x)\diff x=\int_\bbR
    \left[\sum_{n=1}^\infty\chi_{E_n}(x)\diff x\right].
  \]
  Thus,
