...
\begin{solution}
  ...
  sets of $\bfR^n$, it contains all of the closed sets of $\bfR^n$. Now,
  suppose that $\calB'$ is another $\sigma$-algebra containing the closed
  sets in $\bfR^n$. Then, $\calB'\subset\calB$ since $\calB$ contains all
  of the closed sets in $\bfR^n$. However, since $\calB'$ is a
  $\sigma$-algebra, it contains all of the open sets in $\bfR^n$, so
  $\calB'\subset\calB$ since $\calB$ is the smallest $\sigma$-algebra
  containing the open sets in $\bfR^n$. Thus, $\calB'=\calB$.
\end{solution}
...
\begin{solution}
  ...
  \]
  for every $\varepsilon>0$ there exists $N\in\bfN$ such that $n\geq N$
  implies
  \[
  ...
  \[
    m^*(E)\leq m^*(E_n')
  \]
  for all $n\in\bfN$. On the other hand,
  \[
