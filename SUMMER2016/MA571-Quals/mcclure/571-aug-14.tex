...
calculate $\pi_1\left(\bfR^2\setminus\{a,b\},x_0\right)$. You may not use any other
method.
\end{problem}
\begin{proof}
...
convex set. Moreover, note that $U\simeq\bfR^2\setminus\{x_0\}$ and
$V\simeq\bfR^2\setminus\{x_0\}$ (in the case of $U$, first consider the
...
$\pi_1(U,x_0)\cong\pi_1\left(\bfR^2\setminus\{x_0\},y_0\right)\cong\bfZ$ for some
