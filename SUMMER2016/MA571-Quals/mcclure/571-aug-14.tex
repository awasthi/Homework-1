...
calculate $\pi_1\left(\bfR^2\smallsetminus\{a,b\},x_0\right)$. You may not use any other
method.
\end{problem}
\begin{proof}
...
convex set. Moreover, note that $U\simeq\bfR^2\smallsetminus\{x_0\}$ and
$V\simeq\bfR^2\smallsetminus\{x_0\}$ (in the case of $U$, first consider the
...
$\pi_1(U,x_0)\cong\pi_1\left(\bfR^2\smallsetminus\{x_0\},y_0\right)\cong\bfZ$ for some
arbitrary $y_0\neq x_0$ and similarly $\pi_1(V,x_0)\cong\bfZ$. Thus, by the
classical version of the Seifert--van Kampen theorem
\[
\pi_1\left(\bfR^2\smallsetminus\{a,b\},x_0\right)\cong
\frac{\bfZ*\bfZ}{N}
\]
