...
$H(s,1)=s$. Consider the evaluation $H_y\coloneq H(y,t)\circ H(y,t)$ where
...
\[
U\coloneq\left(-\infty,\tfrac{1}{2}\right)\times\bbR
\quad\text{and}\quad
V\coloneq\left(-\tfrac{1}{2},\infty\right)\times\bbR.
\]
...
onto its image $W\coloneq p(C)$, by Lemma A, which is a neighborhood of $x$.
\end{proof}
