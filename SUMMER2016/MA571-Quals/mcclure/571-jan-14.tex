\subsection{MA 571: Qualifying Exam, January 2014}
...
that $V\subseteq U$; in particular, note that $V\cap U\neq\emptyset$. But
...
basic open neighborhood, i.e., an open ball $B((0,0),\varepsilon)\subseteq
...
$A_\alpha\supseteq\bbR^2/{\sim}$. Thus,
$\calA'=\left\{A_\alpha\right\}$ is a finite subset of $\calA$
...
ball $B((0,0),\varepsilon)\subseteq q^{-1}(U)$. But as we have just shown,
for sufficiently small values of $t>0$, $(tx,ty)\in
B((0,0),\varepsilon)\subseteq q^{-1}(U)$. Thus, $[x,y]\in U$. In particular,
...
solution or somehow reconstruct it).
...
C). Then the collection $\calA=\left\{U_x\times
...
Y$. Define $W'=\pi_2(N)\cap Y$. This set is open since it is a
finite intersection of open sets in $Y$. The $W\times W'\subseteq N$. This is
clear since every point $(x,y)\in W\times W'$ is in $N$ ($x\in
W\subseteq U_{x_i}$ for all $i$ which in turn is a subset of $\pi_1(N)$ and
$y\in W'=\pi_2(N)$). Lastly, $W\times W'\supseteq \{x_0\}\times C$ since
$x_0\in W$ and $W'=\pi_1(N)\supseteq C$. Thus, $W\times W'\subseteq N$
