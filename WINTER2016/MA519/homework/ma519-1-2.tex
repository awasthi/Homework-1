...
\end{problem}
\begin{solution*}
  Ignoring degenerate cases such as would arise from \(n<k\), let us
  analyze the situation. We can choose any member of the collection
  \(\{k,\dotsc,n\}\) as a value for \(x_k\)
\end{solution*}
