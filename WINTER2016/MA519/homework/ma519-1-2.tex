...
\end{problem}
\begin{solution*}
  For part (a), without loss of generality we ignore one of the men. Thus,
  there are \(5\) men and \(8\) women which make a total of
  \(\binom{5}{3}\binom{8}{3}\) possible committees.
  \\\\
  For part (b),
  \\\\
  For part (c),
