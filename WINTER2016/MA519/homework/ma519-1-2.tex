...
\begin{solution*}
  ...
  solutions to the equation \(x_1+x_2+x_3+x_4=9\) ways. The answer to that
  latter part is given by the solution to the stars and bars problem which
  in this case is
  \[
    \binom{9-1}{4-1}=\binom{8}{3}.
  \]
  \\\\
  ...
  depending on the \(3\) opportunities we choose, we must consider these
  one by one.
\end{solution*}
