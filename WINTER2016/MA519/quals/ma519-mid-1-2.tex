...
\end{problem}
\begin{solution*}
  Setting the utter wackiness of this problem aside for a moment, let \(X\)
  be a random variable denoting the number of burgers eaten to get the
  \(N\) toys. This is clearly a \(\Geo(\frac{1}{N})\) random variable.
\end{solution*}
