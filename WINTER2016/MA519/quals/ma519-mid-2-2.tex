...
\begin{solution*}
  ...
  \[
    ...
    \end{cases}
  \]
  Keeping this in mind let us compute the joint PDF of \((Y_1,\dotsc,Y_n)\)
  here
  \begin{equation}
    \label{eq:yip:mid-2:3}
    \begin{aligned}
      p(y_1,\dotsc,y_n)%
      &=P(Y_n=y_n\mid Y_{n-1}=y_{n-1},\dotsc,Y_1=y_1)%
      P(Y_{n-1}=y_{n-1},\dotsc,Y_1=y_1)\\
      &=P(Y_n=y_n\mid Y_{n-1}=y_{n-1},\dotsc,Y_1=y_1)\dotsm%
      P(Y_2=y_2\mid Y_1=y_1)%
      P(Y_1=y_1).
    \end{aligned}
  \end{equation}
  ...
  Now,
  \begin{align*}
    P(Y_2=y_2\mid Y_1=y_1)P(Y_1=y_1)
    &=\begin{cases}%
    ...
    \end{cases}\\
    &=\begin{cases}%
      \frac{1}{\lambda^2}\rme^{-\frac{1}{\lambda}y_2}&\text{for \(x>0\),}\\
      0&\text{otherwise.}\\
    \end{cases}
  \end{align*}
  and consequently \eqref{eq:yip:mid-2:3} becomes by repeated application
  of the result above
  \[
    p(y_1,\dotsc,y_n)=
    \begin{cases}
      \frac{1}{\lambda^n}\rme^{-\frac{1}{\lambda}y_n}
      &\text{for \(y_1,\dotsc,y_n>0\),}\\
      0&\text{otherwise.}
    \end{cases}
  \]
\end{solution*}
