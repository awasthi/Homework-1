...
\begin{solution*}
  ...
  \begin{equation}
    ...
    \begin{aligned}
      ...
      &=P(Y_2=y_2,\dotsc,Y_n=y_n)P(Y_1=y_1\mid Y_2=y_2,\dotsc,Y_n=y_n)\\
      &=P(Y_n=y_n)P(Y_{n-1}=y_{n-1}\mid Y_n=y_n)\\
      &\phantom{{}={}}\dotsm%
      P(Y_2=y_2\mid Y_3=y_3,\dotsc,Y_n=y_n)\\
      &\phantom{{}={}\dotsm\dotsm}P(Y_1=y_1\mid Y_2=y_2,\dotsc,Y_n=y_n)\\
      &=
    \end{aligned}
  \end{equation}
\end{solution*}
