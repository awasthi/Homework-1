...
\def\documenttitle{Geometric Group Theory: Notes and Exercises from Druţu and Kapovich}
\def\coursename{Geometric Group Theory}
\def\shorttitle{GeomGroups}
\def\documentsubject{geometric group theory, de la harpe}
...
% \include{chapters/}
% \include{chapters/general-preliminaries}
\end{document}
