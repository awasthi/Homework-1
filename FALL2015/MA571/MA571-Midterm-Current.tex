...
{% begin code
  ...
  \ifx &#1&%
  \section{Problem~Mid-\hwnum.\thesection}
  \global\def\exercisename{Problem Mid-\hwnum.\thesection}%
  \else
  \section{Problem~Mid-\hwnum.\thesection~(#1)}
  \global\def\exercisename{Problem Mid-\hwnum.\thesection(#1)}
  \fi
  \par\vspace{\baselineskip}%
