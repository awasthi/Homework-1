...
$[a,b]$. By Lemma $A$, $S^1\smallsetminus\tilde\iota(x)$ and
...
$S^1\smallsetminus\tilde\iota(x)$ is connected (the map
$(x,y,z)\mapsto(x\cos z+y\sin z,-x\sin z+y\cos z)$, i.e., the rotation map,
