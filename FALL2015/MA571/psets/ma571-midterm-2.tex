...
\end{problem}
\begin{proof}
% Let $q\colon\RR^2\to\RR^2/{\sim}$ be the quotient map. Let $\mathcal{U}$ be
% an open cover of $\RR^2/{\sim}$ and for each $U_\alpha\in\mathcal{U}$ and define
% $V_\alpha\coloneqq p^{-1}(U_\alpha)$.
We will show that the map is not Hausdorff.
\end{proof}
\begin{problem}
