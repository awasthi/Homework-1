...
(and we don't need much) we shall assume that $S^1$ is imbedded in
$\CC$. Now, define the map $\phi\colon S^1\to S^1$ by $\phi(z)\coloneqq
z^2$. This map is continuous since it is a polynomial in $\CC$ and it is a
bijection on $\CC$. Now note that this map preserves the relation
\begin{center}
