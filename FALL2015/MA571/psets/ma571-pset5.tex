...
% separation of $(X\times Y)\complement (A\times B)$. Now, consider
% the embedding $X\hookrightarrow X\times Y$ at a point $y_0\in
% Y\complement B$, i.e, the map $x\mapsto x\times y_0$. Its image in
% $X\times Y$ is the subspace $X\times y_0$. Note that $X\times
% y_0\subset(X\times Y)\complement(A\times B)$ since
% \[
% (X\times Y)\complement(A\times B)=\left\{\,x\times y\in X\times
%  Y\;\middle|\;\text{$x\in X\complement A$ and $y\in Y\complement
%  B$}\,\right\},
% \]
...
% codomain to $(X\times Y)\complement (A\times B)$ yields a continuous
% injection $X\hookrightarrow (X\times Y)\complement(A\times
% B)$. Then by Theorem 23.5, we have that $X\times y_0$ is a
% connected subspace of $(X\times Y)\complement(A\times B)$. Thus, by
