...
% A=\emptyset$, then we shall show that $C\cap A$ and
% $C\cap\left(X\setminus A\right)$ forms a separation of $C$. First
% we will prove that $C\cap A$ and $C\cap\left(X\setminus A\right)$
% are open. Recall that by definition (see Munkres \S17, p.\,102)
% the boundary $\partial A=\clsr A\cap\clsr{X\setminus A}$. Then we
% claim that $\partial A\cap\Int A=\emptyset$ and $\clsr A=\partial
% A\cup\Int A$:
% \begin{lemma}
...
% \end{align*}
% \end{proof}
% Apply Lemma 13 to the closure of $X\setminus A$ and we have
% $\clsr{X\setminus A}=\partial\left(X\setminus
%   A\right)\cap\Int\left(X\setminus A\right)$. But by Lemma 14 this
% is just $\clsr{X\setminus A}=\partial A\cap\Int\left(X\setminus
%   A\right)$. Then, since $C\cap A\subset A\subset\clsr A$ and
% $C\cap A\cap\partial A=\emptyset$ then $C\cap A\subset\Int
% A$. Similarly $C\cap\left(X\setminus
%   A\right)\subset\Int\left(X\setminus A\right)$. In particular,
% both $C\cap A$ and $C\cap\left(X\setminus A\right)$ are
% open. Lastly note that, by Theorem 17.4, that the closure
% $\clsr{C\cap A}=C\cap \clsr A=C\cap\left(\partial A\cup\Int
%   A\right)$ so $\clsr{C\cap A}\cap\left(C\cap\left(X\setminus
%     A\right)\right)=\emptyset$ since $\partial
% A\cap\left(C\cap\left(X\setminus
%     A\right)\right)=\emptyset$. Similarly, $\left(C\cap
%   A\right)\cap\clsr{C\cap\left(X\setminus
%     A\right)}=\emptyset$. Thus, by Lemma 23.1, the
We shall proceed by contradiction. Suppose that $C\cap\partial
