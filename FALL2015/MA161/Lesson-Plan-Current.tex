...
\def\documenttitle{\coursename Lesson Plan \hwnum}
\def\hwnum{MicroTeachingSession}
\def\shorttitle{\coursename-Plan-Micro}
\def\coursename{MA161}
\def\documentsubject{plane and analytic geometry and calculus i}
