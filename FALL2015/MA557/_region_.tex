\message{ !name(../MA557-HW-Current.tex)}\def\documentauthor{Carlos Salinas}
...
\message{ !name(psets/ma557-pset12.tex) !offset(-198) }
prime.
\end{proof}
\newpage
\begin{problem}
...
\end{enumerate}
\end{
\message{ !name(../MA557-HW-Current.tex) !offset(9) }
